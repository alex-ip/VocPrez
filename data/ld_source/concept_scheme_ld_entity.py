...
class ConceptSchemeLDEntity(LDEntity):
    '''
    LDEntity subclass for skos:conceptScheme Linked Data entities
    '''
    _rdf_type = 'skos:ConceptScheme'
    ...
    def get_entities(self):
        '''
        Function to get all skos:ConceptSchemes
        '''
